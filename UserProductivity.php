  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">User Productivity Report</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box-body">
        ...
        $strSQL="SELECT  UserName,EmployeeName, AVG(Quota) AS Quota, AVG(QuotaHours) AS QuotaHours,Sum(TimeSpent) as TimeSpent,Sum(Output) As Output,'Bytes' AS UOM  from wms_view_ProductivityUserWithTito where  [Date]>='$prDateFrom' AND [Date]<='$prDateTO' GROUP BY EmployeeName,UserName";
...
?>
     ...
     <button onclick="exportTableToCSV('UserProductivity.csv')" class="btn btn-danger" id="export">Export</button>
            </div>
