    ...
    <section class="content-header">
      <?php 
        ...
        $ReportID=$_GET['ReportID'];
          ...
          $strSQL="SELECT * From tblreport WHERE ReportID='$ReportID'";
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
               <h3 class="box-title"><?php echo $ReportDescription;?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               
                  <iframe style="height:45vw; width: 100%;"  src=" <?php echo $ReportSource;?>" frameborder="0" allowFullScreen="true"></iframe>
