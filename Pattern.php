...
<body class="hold-transition fixed fixed skin-blue sidebar-mini">
<div class="wrapper">
...
$sTxt =  file_get_contents($Filename); 
?>
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form method="post" action="SaveCaption.php">
            <div class="box-body">
            <fieldset>
              <textarea id="example_1" style="height:15vw; width: 100%;" name="XMLTemplate"><?php echo $sTxt;?></textarea>
            </fieldset>
