  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="ProjectSetup.php">Project Setup</a></li>
        <li class="active">Workflow Setup</li>
      </ol>
    </section>
...
$sql="SELECT * FROM wms_Projects";

?>
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
               <h3 class="box-title"><button type="button" class="btn btn-block btn-primary"  onclick="location.href='addnew_project.php'">Add New</button></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
?>
                <tr>
                  ...
                  <td><button type="button" class="btn btn-xs btn-success"  onclick="location.href='Workflow.php?UID=<?php echo  odbc_result($rs,"ProjectID");?>&TransType=Update&Name=<?php echo odbc_result($rs,"ProjectCode");?>'">Workflow</button>
				  ...
				  <button class="btn btn-xs btn-danger"  data-toggle="modal" data-target="#modal-danger" onclick="Javascript:SetTextBoxValue(<?php echo odbc_result($rs,"ProjectID");?>)">Delete</button></td>
                </tr>
      <?php
	}
