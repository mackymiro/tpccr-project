  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Confidence Level Report</li>
      </ol>
    </section>
...
<?php
				...
				$strSQL="SELECT     Type,Sum([Count]) As TotalVal FROM tblConfidenceLevel WHERE Date>='$From' AND Date<'$To' GROUP BY Type";
    ...
    "drilldown": {
		...
		?>
		
            {
				...
				<?php
				$strSQL1="SELECT     Type,Sum([Count]) As TotalVal,DATENAME(month,Date) AS MonthVal,Month(Date) FROM tblConfidenceLevel WHERE Date>='$From' AND Date<'$To' AND Type='".$row['Type']."' GROUP BY Type,DATENAME(month, Date ),Month(Date) ORDER BY Month(Date) ASC";
