    ...
    <section class="content">
      <div class="row">
        ...
        if ($lTask==""){
              ...
              $sql="SELECT * FROM primo_view_Jobs Where ProcessCode='$Task' and Jobname IN (Select Jobname from primo_view_Jobs Where ProcessCode='$lTask' and statusstring='Done')";      
            }
