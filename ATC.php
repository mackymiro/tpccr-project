...
?>
                <tr>
                 ...
                 <td><?php echo odbc_result($rs,"ReplaceString");?></td>
				  ...
				  <button class="btn btn-xs btn-danger"  data-toggle="modal" data-target="#modal-danger" onclick="Javascript:SetTextBoxValue(<?php echo odbc_result($rs,"id");?>)">Delete</button></td>
                </tr>
      <?php
	}
