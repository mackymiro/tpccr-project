          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
				...
				$strSQL="SELECT wms_Processes.ProcessId,ProcessCode,Description,IsOptional,Quota,IsAutoAllocate FROM   wms_WorkFlowProcesses INNER JOIN wms_Processes ON   wms_WorkFlowProcesses.ProcessId= wms_Processes.ProcessId Where WorkflowID=$WorkflowID ORDER BY wms_WorkFlowProcesses.RefID ASC";
...
?>
                <tr>
				 ...
				 <?php 
				  $strSQL1="Select wms_Processes.ProcessCode FROM  wms_WorkFlowProcessesPrevious INNER JOIN wms_Processes ON wms_WorkFlowProcessesPrevious.PreviousProcessId=wms_Processes.ProcessId Where WorkflowID=$WorkflowID and wms_WorkFlowProcessesPrevious.ProcessId=".$row["ProcessId"];
				...
				{
				?>
				<td><?php echo $row1["ProcessCode"];?></td>
				...
				if($row["IsOptional"]==0){
				?>
					<input type="Checkbox" id="chk" name="chk[]" value="<?php echo $row["BatchId"];?>">
				<?php
				}
				else{
				?>
					<input type="Checkbox" id="chk" name="chk[]" value="<?php echo $row["BatchId"];?>" checked>
				<?php
				}?>
				</td> 
				...
				<?php
				  ...
				  <td><button type="button" class="btn btn-xs btn-success"  onclick="location.href='TaskConfig.php?UID=<?php echo $row["ProcessId"];?>&TransType=Update&Name=<?php echo $row["Description"];?>&ProcessCode=<?php echo $row["ProcessCode"];?>'">Configure</button> <button type="button" class="btn btn-xs btn-primary"  onclick="location.href='PluginConfig.php?UID=<?php echo $row["ProcessId"];?>&TransType=Update&Name=<?php echo $row["Description"];?>&ProcessCode=<?php echo $row["ProcessCode"];?>'">Plugins</button>
				  </td>
                </tr>
				  <?php
