...
<script language="javascript">
	window.location = "fullscr.php?file=<?php echo $filename;?>&BatchID=<?php echo $Batchname;?>&Task=<?php echo $Task;?>";
</script>
<?php
}
else{
...
<script language="javascript">
	window.location = "index.php?page=Enrich&file=<?php echo $filename;?>&BatchID=<?php echo $Batchname;?>&Task=<?php echo $Task;?>";
</script>
