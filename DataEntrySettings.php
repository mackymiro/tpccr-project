        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
               <h3 class="box-title"><button type="button" class="btn btn-block btn-primary"  onclick="location.href='addnew_DataEntry.php'">Add New</button></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
?>
                <tr>
                  ...
                  <td>
				  <button type="button" class="btn btn-xs btn-info"  onclick="location.href='addnew_DataEntry.php?UID=<?php echo $row[0];?>&TransType=Update'">Update</button>
...
?>	  
 ...
 <div class="modal fade" id="modal-default">
  ...
  <div class="control-sidebar-bg"></div>
   ...
   <form method="GET" action="saveDataEntry.php">
